/*CIC NO SLEEP TOGGLE BUTTON USE INFORMATION
-to use this script: create an input button in your dom with id="btnNoSleep"
-to see how the toggle button works: scroll to the end of this file
